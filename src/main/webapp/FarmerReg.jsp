...
<body style=" background-image:url('https://t4.ftcdn.net/jpg/03/03/21/41/360_F_303214121_oNaiP4BcP65GOvcNIiieHlyelQBR3Rdh.jpg'); background-repeat: no-repeat;background-size: cover;">
	...
	<nav class="navbar" >
        ...
        <li  class="km" ><span style="color: orange;">Krushi</span> <span style="color: #0d4706;">Mart</span></li>
			...
			<a class="navmenue" href="" > <li>About</li></a>
			<a class="navmenue" href="" > <li>Contact</li></a>		
		</ul>
    </nav>
</div>
...
<form action="farmerReg" method ="post">
<br><br>
<input placeholder="First Name" type="text" name="fname" required="required"><br><br>
<input placeholder="Surname" type="text" name="lname"><br><br>
<input placeholder="Email" type="text" name="email" required="required"><br><br>
<input placeholder="Phone Number" type="tel" name="phone" required="required"><br><br>
<input placeholder="Address" type="text" name="address" ><br><br>
<input placeholder="Password" type="text" name="password" id=""> <br><br>
<a href="FarmerLogin.jsp" class="flog" > Already Registered?</a><br><br>
